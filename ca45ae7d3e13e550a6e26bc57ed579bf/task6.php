        ...
        <div id="panel-1" class="panel">
            ...
            <?php  $people = [
                ...
                ["image" => "img/demo/authors/josh.png",
                    "image_alt" => "Josh K.",
                    "name" => "Josh K. (ASP.NET Developer)",
                    "job_title" => "Partner &amp: Contributor",
                    "twitter_link_href" => "https://twitter.com/@atlantez",
                    "twitter_link_text" => "@atlantez",
                    "email_link_href" => "https://wrapbootstrap.com/user/walopa",
                    "email_link_text" => '<i class="fal fa-envelope"></i>',
                ...
                <div class="panel-content">
                    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                        ...
                        <?php foreach($people as $person): ?>
                            ...
                            rounded-pill bg-white shadow-sm p-2 border-faded mr-3
d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                ...
                                <div class="ml-2 mr-3">
                                    ...
                                    <a href="<?php echo $person['email_link_href']; ?>" class="text-info fs-sm" target="_blank"
                                       title="<?php echo $person['email_link_title']; ?>">
                                        <?php echo $person['email_link_text']; ?>
                                    </a>
                                </div>
                            </div>
                        <?php endforeach; ?>
